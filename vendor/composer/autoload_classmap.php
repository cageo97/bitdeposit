...
return array(
    ...
    'Merkeleon\\PhpCryptocurrencyAddressValidation\\Exception\\CryptocurrencyValidatorNotFound' => $vendorDir . '/merkeleon/php-cryptocurrency-address-validation/src/Exception/CryptocurrencyValidatorNotFound.php',
    'Merkeleon\\PhpCryptocurrencyAddressValidation\\Utils\\Bech32Decoder' => $vendorDir . '/merkeleon/php-cryptocurrency-address-validation/src/Utils/Bech32Decoder.php',
    'Merkeleon\\PhpCryptocurrencyAddressValidation\\Utils\\Bech32Exception' => $vendorDir . '/merkeleon/php-cryptocurrency-address-validation/src/Utils/Bech32Exception.php',
    'Merkeleon\\PhpCryptocurrencyAddressValidation\\Utils\\CashAddress' => $vendorDir . '/merkeleon/php-cryptocurrency-address-validation/src/Utils/CashAddress.php',
    'Merkeleon\\PhpCryptocurrencyAddressValidation\\Utils\\CashAddressException' => $vendorDir . '/merkeleon/php-cryptocurrency-address-validation/src/Utils/CashAddressException.php',
    'Merkeleon\\PhpCryptocurrencyAddressValidation\\Utils\\Sha3' => $vendorDir . '/merkeleon/php-cryptocurrency-address-validation/src/Utils/Sha3.php',
    'Merkeleon\\PhpCryptocurrencyAddressValidation\\Validation' => $vendorDir . '/merkeleon/php-cryptocurrency-address-validation/src/Validation.php',
    'Merkeleon\\PhpCryptocurrencyAddressValidation\\Validation\\BCH' => $vendorDir . '/merkeleon/php-cryptocurrency-address-validation/src/Validation/BCH.php',
    'Merkeleon\\PhpCryptocurrencyAddressValidation\\Validation\\BTC' => $vendorDir . '/merkeleon/php-cryptocurrency-address-validation/src/Validation/BTC.php',
    'Merkeleon\\PhpCryptocurrencyAddressValidation\\Validation\\DASH' => $vendorDir . '/merkeleon/php-cryptocurrency-address-validation/src/Validation/DASH.php',
    'Merkeleon\\PhpCryptocurrencyAddressValidation\\Validation\\DOGE' => $vendorDir . '/merkeleon/php-cryptocurrency-address-validation/src/Validation/DOGE.php',
    'Merkeleon\\PhpCryptocurrencyAddressValidation\\Validation\\ETH' => $vendorDir . '/merkeleon/php-cryptocurrency-address-validation/src/Validation/ETH.php',
    'Merkeleon\\PhpCryptocurrencyAddressValidation\\Validation\\LTC' => $vendorDir . '/merkeleon/php-cryptocurrency-address-validation/src/Validation/LTC.php',
    'Merkeleon\\PhpCryptocurrencyAddressValidation\\Validation\\ZEC' => $vendorDir . '/merkeleon/php-cryptocurrency-address-validation/src/Validation/ZEC.php',
    ...
    'backend\\controllers\\authcontrol' => $baseDir . '/backend/controllers/authcontrol.php',
    'backend\\controllers\\controller' => $baseDir . '/backend/controllers/controller.php',
    'backend\\controllers\\croncontrol' => $baseDir . '/backend/controllers/croncontrol.php',
    'backend\\controllers\\maincontrol' => $baseDir . '/backend/controllers/maincontrol.php',
    'backend\\functions\\paymentactions' => $baseDir . '/backend/functions/paymentactions.php',
    'backend\\functions\\useractions' => $baseDir . '/backend/functions/useractions.php',
    'backend\\middleware\\uacmiddleware' => $baseDir . '/backend/middleware/uacmiddleware.php',
    'backend\\models\\payments' => $baseDir . '/backend/models/payments.php',
    'backend\\models\\users' => $baseDir . '/backend/models/users.php',
